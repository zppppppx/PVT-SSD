...
../data/waymo/compute_detection_metrics_main ../output/cfgs/waymo_models/pvt_ssd/${EXTRA_TAG}/eval/epoch_no_number/val/default/final_result/data/detection_pred.bin ../data/waymo/gt.bin >> ${LOG_FILE} 2>&1